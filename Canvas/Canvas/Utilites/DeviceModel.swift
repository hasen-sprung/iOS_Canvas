...
public extension UIDevice {
    static var hasNotch: Bool {
        ...
        case .iPhoneX, .iPhoneXR, .iPhoneXS, .iPhoneXSMax: hasNotch = true
        case .iPhone11, .iPhone11Pro, .iPhone11ProMax: hasNotch = true
        case .iPhone12, .iPhone12Pro, .iPhone12ProMax, .iPhone12Mini: hasNotch = true
        case .iPhone13, .iPhone13Pro, .iPhone13ProMax, .iPhone13Mini: hasNotch = true
        default: break
        }
        return hasNotch
    }
